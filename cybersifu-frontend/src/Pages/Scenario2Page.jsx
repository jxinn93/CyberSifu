        ...
        <div className="scenario-container">
            ...
            {currentScene === "thankyou" && (
                <div className="thankyou-section">
                    ...
                    <div className="quiz-section">
                        <h3 className="quiz-question">🧠 What should you do after you fill in a form and realize it was a
                            scam?</h3>
                        <form
                            className="quiz-form"
                            onSubmit={(e) => {
                        ...
                        >
                            ...
                            <br/>
                            <label>
                                <input type="radio" name="postScamAction" value="contact_scammer"/> Contact the scammer
                                to ask for a refund
                            </label>
                            <br/>
                            <label>
                                <input type="radio" name="postScamAction" value="all_correct"/> Stop contact, change
                                passwords, report scam, and monitor accounts
                            </label>
                            <br/>
            ...
            {currentScene === "delete" && (
                <div className="delete-scene">
                    ...
                    <div className="quiz-section">
                        <h3 className="quiz-question">🧠 Quick Quiz: What is the best way to verify a suspicious
                            message?</h3>
                        <form className="quiz-form" onSubmit={(e) => {
                            ...
                            <label>
                                <input type="radio" name="verification" value="click"/> Click the link and see what
                                happens
                            </label><br/>
                            <label>
                            ...
                            <label>
                                <input type="radio" name="verification" value="search"/> Search online or check official
                                sources
                            </label><br/>
